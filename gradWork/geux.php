...
<html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<title>Graduate Work - Graphical Elements of the User Experience</title>
	...
	<body>
		...
		<div class="content">
			...
			<div id="main">
				...
				<div class="right_side">
					...
					<div class="custom">
						<ul>							
							<li class="activePage">GEUX</li>
							<li><a href="/gradWork/ucd.php">User Centered Design</a></li>
							<li><a href="/gradWork/usabilityTesting.php">Usability Testing</a></li>
							<li><a href ="/gradWork/usabilityEngineering.php">Usability Engineering</a></li>
						</ul>
					</div>
				...
				<div class="left_side">
					<div class="item-page">
						...
						<p>
							As the first course of my graduate work I took an elective called
							<strong>Graphical Elements of the User Experience (GEUX)</strong>. This course focused
							on teaching basics of graphic design and artistic concepts for user
							experience-minded students with perhaps a more technical background.
							It involved taking visual ideas from sketching through "production"
							and introduced us to the process of group critique.
						</p>
						
						<h2>Course Work Highlights</h2>
						<hr />
						<p>
							<ul id="myGallery">								
								<li>
								...
								<li>
									<img src="/img/gradWork/geux/logo_final.jpg" title="Themed Logo Final Draft" data-description="The end result of the themed logo project. This isn't a professional quality logo, but this draft could be taken further into production." />
								</li>								
							</ul>
						</p>
						...
						<h2>Project - Themed Logo</h2>
						<p>
							One of the primary projects here was to use a theme to design and prototype a graphical
							logo around that theme. The theme we used was "Picture the Impossible".
						</p>
						
						<p>
							<div align="center">
								<a href="/img/gradWork/geux/logo_sketches.jpg" class="lightbox">
									<img src="/img/gradWork/geux/logo_sketches.jpg" width="500" />
								</a>
								
								<a href="/img/gradWork/geux/logo_final.jpg" class="lightbox">
									<img src="/img/gradWork/geux/logo_final.jpg" width="250" />
								</a>
							</div>
						</p>
						...
						<h2>Final Project - Infographic Video</h2>
						<p>
							The final project for the course was one of our choosing. I took the opportunity
							to dive into Adobe After Effects and create an "infographic" video with some
							kind of random numerical facts put to video form. Keep in mind this was still a 
							year or two before infographic images became a big thing on social networks. I
							started with hand-drawn storyboards on index cards and then went into AE. I had 
							a lot of fun with this project.	I learned a lot about multimedia and motion graphics
							production using After Effects.
						</p>
						
						<p>
							<div align="center">
								<a href="/img/gradWork/geux/storyboard.jpg" class="lightbox">
									<img src="/img/gradWork/geux/storyboard.jpg" width="250" />
								</a>
								     
								<a href="/img/gradWork/geux/AE_screenshot.png" class="lightbox">
									<img src="/img/gradWork/geux/AE_screenshot.png" width="250" />
								</a>
							</div>
						</p>
						...
						<p>
							<div align="center">
								<iframe width="480" height="360" src="//www.youtube.com/embed/auieY8i9Kj0" frameborder="0" allowfullscreen></iframe>
							</div>
						</p>
		...
		<!-- Actiate JQuery Lightbox by referencing all links on the page with "lightbox" in the "class" attribute -->
		<script type="text/javascript">
			$(function()
			{
