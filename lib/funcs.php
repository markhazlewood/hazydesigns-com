<?php
	...
	function echoMainContent($mainContent, $sidebarContent)
	{
		echo '
			<div id="main">
			...
			<div id="footer">
				<div class="info">
					...
					<!--
						...
						echo "document.write('<a ' + path + '\'' + prefix + ':' + addy85594 + '\'>');";
						echo '
	...
	function activateGalleryView($galleryCssId, $width, $height)
	{
		echo '
